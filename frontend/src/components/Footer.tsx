      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-blue-400 mb-4">ProductCatalog</h3>
            <p className="text-gray-300 mb-4">
              Your comprehensive solution for modern product management. 
              Streamline your workflow and manage products with ease.
            </p>
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-300">
              <p>Email: kamlesh@ProductCatalog.com</p>
              <p>Phone: +91 (760) 059-0099</p>
              <p>Address: 123 Product Street, Tech City</p>
            </div>
          </div>
        </div>
